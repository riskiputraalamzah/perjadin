    ...
    <div class="card" v-if="selectedItem != null">
      ...
      <div class="card-body">
        <div id="content" class="content-to-pdf">
          <div class="row align-items-center border-black border-bottom border-5">
            <div class="col-4">
              <img src="/assets/images/gmbr_3.png" class="img-fluid" alt="" />
            </div>
            <div class="col-8">
              <div class="text-center title">
                ...
                <h5 class="m-0">BALAI PELATIHAN VOKASI DAN PRODUKTIVITAS</h5>
                <p class="m-0 fs-2">
